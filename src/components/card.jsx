export default function App() {
  return (
    <div className="bg-[#031900] min-h-screen p-5">
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-red-500 rounded-xl p-10 text-center">
          ...
          />
          <button className="bg-white px-10 py-4 rounded-full font-bold">
            SHOP NOW
          </button>
        </div>
        ...
        <div className="bg-orange-600 rounded-xl p-10 text-center">
          <h2 className="text-5xl font-bold text-white uppercase pr-221">
           ...
           <p className="text-white mt-5 pr-375">$44 per pack</p>
           <p className="text-white mt-5 pr-375">$44 per pack</p>
           <p className="text-white mt-5 pr-375">$44 per pack</p>
          <img
